...
// ---------------------------------------------------------------------------
// Module 5 demo data: job pricing, held apart from the job itself
// ---------------------------------------------------------------------------

export const DEMO_JOB_PRICING: JobPricingDocument[] = [
  {
    id: 'demo-job-1',
    jobId: 'demo-job-1',
    lines: [
...
// ---------------------------------------------------------------------------
// Module 10 demo data: bills, receipts and materials
// ---------------------------------------------------------------------------
...
export const DEMO_INVOICES: Invoice[] = [
  {
    ...
    customerAddress: '18 Station Road, Jaipur 302006',
    invoiceDate: stamp(15),
    lines: DEMO_PRICING_LINES,
    subtotal: rate(5500),
    discount: { amount: rate(250), reason: 'Festival offer' },
    total: rate(5250),
    paid: rate(2000),
    status: 'partial',
    terms: 'Payment due on delivery. Goods once sold are not taken back.',
    createdAt: stamp(15),
    createdBy: DEMO_OWNER_UID,
    updatedAt: stamp(16),
    updatedBy: DEMO_OWNER_UID,
  },
  {
    ...
    jobId: 'demo-job-2',
    jobNumber: 'JOB-2627-0002',
    jobTitle: 'Clinic signage board',
    customerId: 'demo-customer-1',
    customerName: 'Dr. Meera Sharma',
    customerMobile: '9829100011',
    customerAddress: '4 Civil Lines, Jaipur 302006',
    invoiceDate: stamp(12),
    lines: DEMO_PRICING_LINES.slice(0, 1),
    subtotal: rate(3000),
    discount: null,
    total: rate(3000),
    paid: rate(0),
    status: 'unpaid',
    notes: 'Board delivered to the clinic reception.',
    terms: 'Payment due on delivery. Goods once sold are not taken back.',
    createdAt: stamp(12),
    createdBy: DEMO_OWNER_UID,
    updatedAt: stamp(12),
...
export const DEMO_PAYMENTS: Payment[] = [
  {
    ...
    paidAt: stamp(16),
    mode: 'upi',
    reference: 'UPI 4471 2290',
    note: 'Advance against the hoardings.',
    recordedById: DEMO_OWNER_UID,
...
export const DEMO_INVENTORY_ITEMS: InventoryItem[] = [
  {
    id: 'demo-material-1',
    name: 'Flex 440 GSM roll',
    category: 'media',
    unit: 'sq-ft',
    currentStock: 1240,
    minimumStock: 500,
    notes: 'Standard outdoor flex, 10 ft width.',
    isActive: true,
    createdAt: stamp(2),
    createdBy: DEMO_OWNER_UID,
    updatedAt: stamp(16),
  ...
  {
    id: 'demo-material-2',
    name: 'Solvent ink - cyan',
    category: 'ink',
    unit: 'litre',
    currentStock: 3,
    minimumStock: 5,
    notes: 'Reorder from the Jaipur supplier.',
    isActive: true,
    createdAt: stamp(2),
    createdBy: DEMO_OWNER_UID,
    updatedAt: stamp(15),
  ...
  },
  {
    ...
    currentStock: 0,
    minimumStock: 2,
    notes: 'Out of stock since the last vinyl job.',
    isActive: true,
    createdAt: stamp(2),
    createdBy: DEMO_OWNER_UID,
    updatedAt: stamp(13),
...
export const DEMO_INVENTORY_TRANSACTIONS: InventoryTransaction[] = [
  ...
  },
  {
    ...
    jobId: 'demo-job-1',
    jobNumber: 'JOB-2627-0001',
    reason: 'Two hoardings, 10 x 6 ft with wastage.',
    at: stamp(16),
    byId: DEMO_OWNER_UID,
    byName: 'Demo Owner',
  },
  {
    ...
    itemName: 'Aluminium frame section',
    unit: 'running-ft',
    direction: 'out',
    quantity: 64,
    balanceAfter: 180,
    jobId: 'demo-job-1',
    jobNumber: 'JOB-2627-0001',
    reason: 'Frames for both hoardings.',
    at: stamp(14),
    byId: DEMO_OWNER_UID,
    byName: 'Demo Owner',
  },
  {
    id: 'demo-stock-4',
    itemId: 'demo-material-4',
    itemName: 'Matte lamination film',
    unit: 'roll',
    direction: 'out',
    quantity: 2,
    balanceAfter: 0,
    jobId: 'demo-job-2',
    jobNumber: 'JOB-2627-0002',
    reason: 'Clinic board lamination.',
    at: stamp(13),
    byId: DEMO_OWNER_UID,
    byName: 'Demo Owner',
  },
